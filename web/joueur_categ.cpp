...
/*  QMediaPlayer * player=new QMediaPlayer;
  ...
  player->setMedia(QUrl::fromLocalFile("C:/Users/Espace Sboui/Downloads/Video/video-1524575118.mp4"));
  v->setGeometry(100,100,300,400);
  v->show();
  player->play();
  qDebug();*/

}
 void joueur_categ::showTime()
 {
...
{   son->play();
    ui->nom_modif->setText(ui->tableView->model()->data(ui->tableView->model()->index(ui->tableView->selectionModel()->currentIndex().row(),3)).toString());
    ui->prenom_modif->setText(ui->tableView->model()->data(ui->tableView->model()->index(ui->tableView->selectionModel()->currentIndex().row(),4)).toString());
    ui->email_modif->setText(ui->tableView->model()->data(ui->tableView->model()->index(ui->tableView->selectionModel()->currentIndex().row(),6)).toString());
    ...
    ui->id_2->setText(ui->tableView->model()->data(ui->tableView->model()->index(ui->tableView->selectionModel()->currentIndex().row(),2)).toString());
...
void joueur_categ::on_pushButton_clicked()
{
...
void joueur_categ::on_pushButton_2_clicked()
{
