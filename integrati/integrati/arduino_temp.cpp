...
int Arduino_temp::connect_arduino()
{
    ...
    qDebug() << "arduino_temp_port_name is :" << arduino_port_name;
...
QSerialPort* Arduino_temp::getserial(){
    return serial;
}


QString Arduino_temp::getarduino_port_name(){

    return arduino_port_name;
}


int Arduino_temp::close_arduino()
{
    if(serial->isOpen()){
        serial->close();
        return 0;
...
QString Arduino_temp::read_from_arduino(){
...
int Arduino_temp::write_to_arduino( QByteArray d)
{
