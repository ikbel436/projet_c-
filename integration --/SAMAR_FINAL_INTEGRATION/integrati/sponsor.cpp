...
void sponsor::afficher_sponsor(Ui::integration *ui)
{
    QSqlQuery q;
...
bool sponsor::Supprimer_sponsor(Ui::integration *ui)
{
    QSqlQuery q;
...
bool sponsor::modifier_sponsor(Ui::integration *ui)
{
...
void sponsor::Recherche_sponsor(Ui::integration *ui)
{
    QSqlQuery q;
    QSqlQueryModel *modal=new QSqlQueryModel();
...
void sponsor::Tri_NOM_Sponsor(Ui::integration *ui)
{
    QSqlQuery q;
...
void sponsor::Tri_Tel(Ui::integration *ui)
{
    QSqlQuery q;
    QSqlQueryModel *model=new QSqlQueryModel();
...
void sponsor::Tri_Adresse(Ui::integration *ui)
{
    QSqlQuery q;
    QSqlQueryModel *model=new QSqlQueryModel();
...
void sponsor::total(Ui:: integration *ui)
{
...
void sponsor::nbeventsponsor(Ui:: integration *ui)
{
...
q.prepare("SELECT count(idE) as total,nom FROM  sponsor  GROUP BY nom ");
