...
void empfou::on_recherche_emp_textChanged(const QString &arg1)
{
    QString rech;
...
void empfou::on_pushButton_camera_clicked()
{
...
void empfou::on_nb_four_clicked()
{
    FOURNISSEURS F;
      son->play();
