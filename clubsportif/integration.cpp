...
//arduinotemperature
    ...
    case(-1):qDebug() << "arduino is not available";
     ...
     this->setStyleSheet("color: darkblue; background-color: ");
        ...
        son->setMedia(QUrl("C:/Users/msi/Desktop/integration/integratif/clubsportif/sons/bruit-clic.wav"));
        son->setVolume(40);
         supp->setMedia(QUrl("C:/Users/msi/Desktop/integration/integratif/clubsportif/sons/supprimer.wav"));
         supp->setVolume(40);
          ajout->setMedia(QUrl("C:/Users/msi/Desktop/integration/integratif/clubsportif/sons/ajouter.wav"));
          ajout->setVolume(40);
          music2->setMedia(QUrl("C:/Users/msi/Desktop/integration/integratif/clubsportif/sons/music.mp3"));
          music2->setVolume(20);
          music2->stop();
          /************************* MALAK****************************/
        EVENT e ;
...
{son->play();
  QFile file ("C:/Users/msi/Desktop/myfile.txt");
