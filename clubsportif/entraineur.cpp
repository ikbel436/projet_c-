...
void entraineur::afficher(Ui:: integration *ui)
{
    QSqlQuery q;
...
bool entraineur::Supprimer(Ui:: integration *ui)
{
    QSqlQuery q;
    QString id = ui->tableView_e->model()->data(ui->tableView_e->model()->index(ui->tableView_e->selectionModel()->currentIndex().row(),0)).toString();
    q.prepare("DELETE FROM entraineur WHERE id ='"+id+"'");
    q.exec();
}

bool entraineur::modifier(Ui:: integration *ui)
{
...
void entraineur::Recherche(Ui:: integration *ui)
{
    QSqlQuery q;
    QSqlQueryModel *modal=new QSqlQueryModel();
    QString rech =ui->recherche_e->text();
...
void entraineur::Tri_NOM(Ui:: integration *ui)
{
    QSqlQuery q;
...
void entraineur::Tri_prenom(Ui:: integration *ui)
{
    QSqlQuery q;
    QSqlQueryModel *model=new QSqlQueryModel();
...
void entraineur::Tri_DATE(Ui:: integration *ui)
{
    QSqlQuery q;
    QSqlQueryModel *model=new QSqlQueryModel();
...
/*
void entraineur::pdf(Ui:: integration *ui)
{
...
void entraineur::test(Ui:: integration *ui)
{
QSqlQuery q;
QSqlQueryModel * modal =new QSqlQueryModel();
...
void entraineur::totalentrain(Ui:: integration *ui)
{


    QSqlQuery q;
    QSqlQueryModel *model=new QSqlQueryModel();
    q.prepare("select count(*) as total from entraineur ");
    q.exec();
    model->setQuery(q);
