...
void JOUEURS::afficher(Ui::integration *ui)
{
    QSqlQuery q;
    ...
    q.exec();
    modal->setQuery(q);
    ui->tableView_j->setModel(modal);
}



bool JOUEURS::Supprimer(Ui::integration *ui)
{
    QSqlQuery q;
    QString id = ui->tableView_j->model()->data(ui->tableView_j->model()->index(ui->tableView_j->selectionModel()->currentIndex().row(),2)).toString();
    q.prepare("DELETE FROM joueurs WHERE id ='"+id+"'");
    q.exec();
}

bool JOUEURS::modifier(Ui::integration *ui)
{
...
void JOUEURS::Recherche(Ui::integration *ui)
{
    QSqlQuery q;
    QSqlQueryModel *modal=new QSqlQueryModel();
    QString rech =ui->recherche_j->text();
...
void JOUEURS::Tri_NOM(Ui::integration *ui)
{
    QSqlQuery q;
    ...
    q.exec();
    model->setQuery(q);
    ui->tableView_j->setModel(model);
}
void JOUEURS::Tri_ID(Ui::integration *ui)
{
    QSqlQuery q;
    QSqlQueryModel *model=new QSqlQueryModel();
...
void JOUEURS::Tri_DATE(Ui::integration *ui)
{
    QSqlQuery q;
    QSqlQueryModel *model=new QSqlQueryModel();
...
void JOUEURS::Recherche1(Ui::integration *ui)
{
    QSqlQuery q;
    QSqlQueryModel *modal=new QSqlQueryModel();
...
void JOUEURS::pdf(Ui::integration *ui)
{
    QString fileName = QFileDialog::getSaveFileName((QWidget* )0, "Export PDF", QString(), "*.pdf");
        ...
        QString pdf="<br> <h1  style='color:red'>LISTE DES Joueurs  <br></h1>\n <br> <table>  <tr>  <th> ID  </th> <th> NOM  </th> <th> Prenom </th> <th> Date Naissance </th> <th> Email </th> <th> Tel </th></tr>" ;
