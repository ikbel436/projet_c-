...
void joueur_categ::on_excel_clicked()
{
  ajout->play();
    QString fileName = QFileDialog::getSaveFileName(this, tr("Exportation en fichier Excel"), qApp->applicationDirPath (),
        ...
        obj.addField(6, "role", "char(20)");
        obj.addField(7, "salaire", "char(20)");
...
{   son->play();
    ...
    ui->prix_modif_2->setText(ui->tableView->model()->data(ui->tableView->model()->index(ui->tableView->selectionModel()->currentIndex().row(),6)).toString());
...
void joueur_categ::on_modifier_clicked()
{
  ...
  ajout->play();
    if(e.modifier(ui))
    {
        QMessageBox ::information(this,"","employes modifié")  ;
...
{  ajout->play();
   int ide=ui->id->text().toInt();
    ...
    QString role=ui->lieu->text();
    QString email=ui->prix->text();
     int tel=ui->nb->text().toInt();
     int salaire=ui->salair->text().toInt();
...
{   ajout->play();
    QPdfWriter pdf("C:/Users/Espace Sboui/Desktop/club_event/club_event/PDF/pdf");
                         ...
                         int i = 4000;
                              ...
                              painter.drawText(3000,2000,"Liste Des employes");
                             ...
                             //painter.drawText(1100,2000,afficheDC);
                              ...
                              painter.drawText(5100,3300,"email ");
                               ...
                               painter.drawText(8100,3300,"role ");
                               painter.drawText(10100,3300,"salaire ");
                              ...
                              while (query.next())
                              {
                                  ...
                                  painter.drawText(8100,i,query.value(7).toString());
